...
function SideBar({ onNotebookClick }: SideBarProps) {
  ...
  const setAddNoteOpen = () => {
    setIsAddNoteOpen(true);
  };
  const setAddNoteClosed = () => {
  ...
  const handleNotebookClick = (id: number, name: string) => {
    setSelectedListItem(id);
    onNotebookClick(name);
  };
  ...
  return (
    <>
      <aside className="side-bar">
        ...
        <button className="new-note-btn" onClick={setAddNoteOpen}>
        ...
        <ul className="notebook-list">
          ...
          {notebook.map((notebook) => (
            <div key={notebook.id}>
              <li
                onClick={() => handleNotebookClick(notebook.id, notebook.name)}
                className={
                  selectedListItem === notebook.id
